<template>
  ...
  >
    <SfDrawer
      ...
      :disable-esc="true"
      class="w-full rounded shadow-none md:translate-x-0 z-[100] md:z-0 md:static md:!block -translate-x-full shrink-0 md:w-[200px] lg:w-[288px] bg-white overflow-y-auto"
